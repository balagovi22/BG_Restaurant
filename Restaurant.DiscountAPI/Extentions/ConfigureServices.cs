...
using Restaurant.DiscountAPI.MappingProfile;
using Restaurant.DiscountAPI.Repository;

namespace Restaurant.DiscountAPI.Extentions
{
    public static class ConfigureServices
    {
        ...
        private static void ConfigureSwagger(IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Title = "Mango.Services.DiscountAPI",
                });
                c.EnableAnnotations();
        ...
        private static void ConfigureDatabase(IServiceCollection services, IConfiguration configuration)
        {
            ...
            .AddDbContext<ApplicationDbContext>(options => options.UseSqlServer
                        (configuration.GetConnectionString("DiscountAPIConnection")));
        }
